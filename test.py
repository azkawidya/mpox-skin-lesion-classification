...
def main():
    ...
    test_loader = DataLoader(getImageLabel(original=f'C:/Studi_Kasus/Dataset/Original Images/Original Images/FOLDS/', folds=folds, subdir=['Test']), batch_size=BATCH_SIZE, shuffle=True)
    ...
    sn.heatmap(df_cm, annot=True, cmap='inferno')
